...
const CACHE_VERSION = "2026-07-16-184";
...
const APP_SHELL = [
  ...
  "/satsang-bookmarks.js?v=37",
  "/satsang-search.js?v=3",
  "/data/satsang-talks.json",
  "/excerpts-playlist.js?v=28",
  ...
  "/sadguru-smaran-cta.js?v=8",
  "/my-photos.js?v=1",
  "/quotes-carousel.js?v=5",
  "/quick-jump.js?v=1",
